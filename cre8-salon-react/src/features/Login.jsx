      ...
      <div className="login-wrapper portal-init-mode">
        ...
        <div className="portal-loading-content">
          <div className="portal-logo-pulse">
            <img src={`${import.meta.env.BASE_URL}logo.png`} alt="Logo" className="portal-logo-large" />
          </div>
  ...
  return (
    <div className="login-wrapper">
      ...
      <div className="auth-header-top">
        <img src={`${import.meta.env.BASE_URL}logo.png`} alt="Logo" className="auth-logo-fixed" />
      </div>
